...
def parseArgs(args):
    ...
    globalArgs.add_argument('--func', choices=["test", "train", "predict", "dataclean"],
                            type=str, action='store', help='function route')
    ...
    globalArgs.add_argument('--playDataset', type=int, nargs='?', const=10, default=None, help='')
    globalArgs.add_argument('--reset', action='store_true', help='')
    globalArgs.add_argument('--verbose', action='store_true', help='')
    globalArgs.add_argument('--debug', action='store_true', help='')
    globalArgs.add_argument('--keepAll', action='store_true', help='')
    ...
    globalArgs.add_argument('--watsonMode', action='store_true', help='')
    globalArgs.add_argument('--autoEncode', action='store_true', help='')
