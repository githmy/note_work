...
class NLP:
    ...
    """
    default_user_dict_dir = 'dict/'  # 默认的用户词典目录，清华大学法律词典
    ...
    def __init__(self, user_dict_dir=default_user_dict_dir, model_dir=default_model_dir):
        ...
        # print(self.default_user_dict_dir)
        # print(self.default_model_dir)
        # 初始化分词器
        # pynlpir.open()  # 初始化分词器
        ...
        # 依存句法分析模型
        self.parser = Parser()
        # parse_flag = self.parser.load(os.path.join(self.default_model_dir, 'pisrl_win.model'))
