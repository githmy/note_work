...
# argparse receiving list of classes to be ignored (e.g., python mainx.py --ignore person book)
parser.add_argument('-i', '--ignore', nargs='+', type=str, help="ignore a list of classes.")
# argparse receiving list of classes with specific IoU (e.g., python mainx.py --set-class-iou person 0.7)
...
if args.ignore is None:
    args.ignore = []
# args.ignore = [str(classid + 1) for classid in range(18)]
# args.ignore = [classid + 1 for classid in range(18)]
...
baspath = os.path.join("..", "data", "keen")
GT_PATH = os.path.join(os.getcwd(), baspath, "predict")
DR_PATH = os.path.join(os.getcwd(), baspath, "out")
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), baspath, "predict")
...
"""
TEMP_FILES_PATH = os.path.join("..", "data", "keen", ".temp_files")
if not os.path.exists(TEMP_FILES_PATH):  # if it doesn't exist already
    os.makedirs(TEMP_FILES_PATH)
output_files_path = os.path.join("..", "data", "keen", "mAP")
        ...
        for idx, detection in enumerate(dr_data):
            ...
            if show_animation:
                ...
                if ovmax > 0:  # if there is intersections between the bounding-boxes
                    ...
                    cv2.putText(img_cumulative, class_name, (bbgt[1], bbgt[0] - 5), font, 0.6, light_blue, 1,
                                cv2.LINE_AA)
    ...
    for tmp_file in gt_files:
        ...
        for obj in ground_truth_data:
            if not obj['used']:
                ...
                cv2.rectangle(img, (bbgt[1], bbgt[0]), (bbgt[3], bbgt[2]), pink, 2)
